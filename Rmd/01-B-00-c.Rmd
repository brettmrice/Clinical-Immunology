...
*   **Valency:** The number of antigen-binding sites on a single antibody molecule (e.g., IgG has a valency of 2; IgM has a valency of 10)
*   **Half-life:** The time required for the concentration of a substance (like an immunoglobulin) in the body to be reduced by one-half; a key indicator of its persistence
*   **Complement Fixation:** The ability of an antibody's Fc region, once bound to an antigen, to bind and activate the C1q component of the classical complement pathway
*   **Opsonin:** A molecule (like IgG) that coats a pathogen and enhances its binding to phagocyte receptors, thereby promoting phagocytosis
*   **Passive Immunity:** Temporary immunity acquired by receiving pre-formed antibodies from another individual, such as a fetus receiving maternal IgG across the placenta or an infant receiving IgA from breast milk
*   **Agglutination:** The cross-linking and clumping of particulate antigens (like bacteria or red blood cells) by antibodies, a process greatly enhanced by high-valency IgM
*   **Avidity:** The overall, cumulative binding strength of a multivalent antibody to a multivalent antigen. It is the sum total of all the individual affinities (e.g., IgM's high avidity due to its 10 binding sites)
