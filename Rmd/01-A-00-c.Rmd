...
*   **V(D)J Recombination:** The unique genetic process in developing lymphocytes that randomly shuffles and joins gene segments (V, D, J) to create novel genes for antibody and T-cell receptor variable regions
*   **Somatic Recombination:** Genetic recombination that occurs in somatic (non-germline) cells, such as a maturing B-cell. This means the changes are not passed on to offspring
*   **RAG Enzymes (Recombination-Activating Genes):** The specialized "molecular scissors" that perform the cutting and pasting of DNA during V(D)J recombination
*   **Junctional Diversity:** The introduction of random nucleotide variations at the junctions of V, D, and J segments during recombination, which massively increases the diversity of the antigen-binding site
*   **Polymorphism:** The existence of many different forms (alleles) of a single gene within a population. The HLA genes are the most polymorphic genes in humans
*   **HLA (Human Leukocyte Antigen):** The human version of the Major Histocompatibility Complex (MHC). These are the cell surface molecules that present antigens to T-cells
*   **Haplotype:** The specific set of HLA alleles that an individual inherits together from one parent on a single chromosome
